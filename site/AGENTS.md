...
- Hero recap entrance: keep the full event recap visible in the first-screen Hero as a large, book-like editorial object rather than a small button. It opens `https://lanna-field-notes-chiang-mai.vercel.app/`, remains visually prominent on desktop and mobile, and localizes its cover/CTA copy in Chinese, Thai, and English.
